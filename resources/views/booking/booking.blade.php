    ...
    <main class="py-6 bg-slate-100">
        <div class="max-w-7xl mx-auto hp:px-3 lg:px-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {{-- <!-- Komponen Input Informasi Pengguna -->
                        ...
                        <form class="w-full p-14 pb-16 bg-white rounded-lg shadow-xl items-center" method="POST">
                            ...
                            <div class="">
                                ...
                                <input
                                    ...
                                    id="nama" placeholder="Nama Lengkap" aria-label="Email" name="nama" value="">
                            </div>
                            <div class="mt-2">
                                <label class="block text-base text-gray-600" for="cus_email">Email</label>
                                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded border-slate-300"
                ...
                <div class="lg:flex">
                    ...
                    <section class="flex flex-row lg:w-1/2 justify-content-center mt-6">
                        <div class="pointer-events-auto w-screen lg:max-w-md">
                            <div class="leading-loose flex flex-col lg:ml-6 bg-white rounded-lg">
                                <form class="w-full p-5 bg-white rounded-lg shadow-lg">
                                    <p class="text-dark text-xl font-bold mb-2 uppercase">Input Data Pemesan</p>
                                    <div id="">
                                        <div class="">
                                            <label class="block text-base text-dark" for="cus_email">Nama</label>
                                        ...
                                        <div class="">
                                            <label class="text-base text-dark" for="cus_email">Kota Domisili</label>
                                            <input class="w-full px-2 py-2 text-gray-500 bg-gray-200 rounded"
                                                id="addProvinsi" value="">
                                        </div>
                                        <div class="inline-block w-1/2 pr-1">
                                            <label class="text-base text-dark" for="cus_email">Negara</label>
                                            <input class="w-full px-2 py-2 text-gray-500 bg-gray-200 rounded"
                                                id="addNegara" value="">
                                        </div>
                            ...
                            <div class="flex flex-col lg:ml-6 mt-3 bg-white rounded-lg shadow-lg hp:mt-6">
