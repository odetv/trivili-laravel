<x-app-layout>
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    <h4 class="font-bold uppercase text-primary text-lg mb-5">Tentukan destinasi liburan Anda bersama
                        kami</h4>
                ...
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <div class="flex items-center">
                        <!-- Whatsapp -->
                        <a href="https://wa.me/6285739683673" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-dark text-dark transition duration-300 ease-in-out hover:bg-primary hover:text-white">
    ...
    <section id="partner" class="pt-36 pb-32 bg-slate-200">
        <div class="container">
            ...
            <div class="w-full px-4">
                <div class="flex flex-wrap items-center justify-center">
                    <a href="#"
                        class="max-w-[80px] mx-4 py-4 grayscale opacity-50 transition duration-300 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8 hover:scale-105 ease-in-out">
                        <img src="img/partner/logo-maimelali.png" alt="">
                    </a>
                    <a href="#"
                        class="max-w-[70px] mx-4 py-4 grayscale opacity-50 transition duration-300 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8 hover:scale-105 ease-in-out">
                        <img src="img/partner/logo-infosingaraja.png" alt="">
                    </a>
                    <a href="#"
                        class="max-w-[120px] mx-4 py-4 grayscale opacity-50 transition duration-300 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8 hover:scale-105 ease-in-out">
                        <img src="img/partner/logo-wonderfullindonesia.png" alt="">
                    </a>
                    <a href="#"
                        class="max-w-[70px] mx-4 py-4 grayscale opacity-50 transition duration-300 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8 hover:scale-105 ease-in-out">
                        <img src="img/partner/logo-pemprov-bali.png" alt="">
                    </a>
                </div>
            </div>
        </div>
    ...
    <section id="contact" class="pt-36 pb-32 bg-slate-100">
        <div class="container">
            ...
            <form action="contact.php" method="post" onSubmit="return ValidasiForm()" name="FormContact">
                <div class="w-full lg:w-2/3 lg:mx-auto">
                    <div class="w-full px-4 mb-8">
                        <label for="name" class="text-base text-dark ">Nama</label>
                        <input type="text" id="name"
                            class="w-full text-dark p-3 rounded-md transition duration-300 ease-in-out focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary border-slate-200" />
                    </div>
                    <div class="w-full px-4 mb-8">
                        <label for="email" class="text-base text-dark ">Email</label>
                        <input type="email" id="email"
                            class="w-full text-dark p-3 rounded-md transition duration-300 ease-in-out focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary border-slate-200" />
                    </div>
                    <div class="w-full px-4 mb-8">
                        <label for="message" class="text-base text-dark ">Pesan</label>
                        <textarea type="text" id="message"
                            class="w-full text-dark p-3 rounded-md transition duration-300 ease-in-out focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-32 border-slate-200"></textarea>
                    </div>
                    <div class="w-full px-4">
                        <button class="text-base text-white bg-primary rounded-md py-3 px-8 w-full hover:shadow-lg hover:opacity-50
                        transition duration-300 ease-in-out">Kirim</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="container">
            ...
            <div class="w-full pt-10 border-t border-slate-500">
                <div class="flex items-center justify-center mb-5">
                    <!-- Whatsapp -->
                    <a href="https://github.com/odetv/PROJECT-TEKNOWEB/tree/master/TUGAS%204%20(20-10-2022)/trivili-tailwindcss" target="_blank"
